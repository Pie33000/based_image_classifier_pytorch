...
# cnn_classifier documentation build
...
from cnn_classifier import __version__ as release
...
htmlhelp_basename = "cnn_classifierdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "cnn_classifier",
        "Project cnn_classifier codebase.",
        "Data-Science",
    )
]
